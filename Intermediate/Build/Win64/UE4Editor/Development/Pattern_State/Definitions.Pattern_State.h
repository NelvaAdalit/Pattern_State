...
#define UE_PROJECT_NAME Pattern_State
#define UE_TARGET_NAME Pattern_StateEditor
#define UE_MODULE_NAME "Pattern_State"
...
#define PATTERN_STATE_API DLLEXPORT
